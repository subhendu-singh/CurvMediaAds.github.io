        ...
        <!--========== PROMO BLOCK ==========-->
        <div class="js__parallax-window" style="background: url(img/1920x1080/miroslav-bobryshev.jpg) 50% 0 no-repeat fixed;">
            <div class="g-container--md g-text-center--xs g-padding-y-150--xs">
                <div class="g-margin-b-60--xs">
                    <h1 class="g-font-size-40--xs g-font-size-50--sm g-font-size-70--md g-color--white g-letter-spacing--1 g-margin-b-30--xs">SHOWREELS IN MEDIA</h1>
            ...
            <div class="container g-padding-y-80--xs g-padding-y-125--sm">
                ...
                <div class="row">
                    <div class="col-sm-3 g-margin-b-30--xs g-margin-b-0--md">
                        <!-- News -->
                        <article>
							<img class="img-responsive" src="img/970x970/reel.png" alt="Image" style="height:100%;width:100%;">
                            <div class="g-bg-color--white g-box-shadow__dark-lightest-v2 g-text-center--xs g-padding-x-40--xs g-padding-y-40--xs">
								<p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2">
								<a href="#lion_king" data-toggle="modal">FILM REEL</p></a>
								<p>Showcasing the incredible feature film visual effects work crafted by CurveMediaAds Film artists.</p>
                            </div>
                        </article>
                        <!-- End News -->
                    </div>
                    <div class="col-sm-3 g-margin-b-30--xs g-margin-b-0--md">
                        <!-- News -->
                        <article>
                            <img class="img-responsive" src="img/970x970/trch.png" alt="Image" style="height:100%;width:100%;">
                            <div class="g-bg-color--white g-box-shadow__dark-lightest-v2 g-text-center--xs g-padding-x-40--xs g-padding-y-40--xs">
                                <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2">
								<a href="#technicolor" data-toggle="modal">TECHNICOLOR VISUALIZATION REEL</p></a>
                                <p>Technicolor Pre-Production Services is delighted to bring you it’s latest Visualization reel. B</p>
                            </div>
                        </article>
                        <!-- End News -->
                    </div>
                    <div class="col-sm-3">
                        <!-- News -->
                        <article>
                            <img class="img-responsive" src="img/970x970/lion.png" alt="Image" style="height:100%;width:100%;">
                            <div class="g-bg-color--white g-box-shadow__dark-lightest-v2 g-text-center--xs g-padding-x-40--xs g-padding-y-40--xs">
                                <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2">
									<a href="#film" data-toggle="modal">FILM REEL</a>
								</p>
                                <p>Check out CurveMediaAds 2019 Film Reel!</p>
                            </div>
                        </article>
                        <!-- End News -->
                    </div>
                    <div class="col-sm-3 g-margin-b-30--xs g-margin-b-0--md">
                        <!-- News -->
                        <article>
                            <img class="img-responsive" src="img/970x970/creature.png" alt="Image" style="height:100%;width:100%;">
                            <div class="g-bg-color--white g-box-shadow__dark-lightest-v2 g-text-center--xs g-padding-x-40--xs g-padding-y-40--xs">
                                <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2">
									<a href="#creature" data-toggle="modal">CREATURE REEL</a>
								</p>
                                <p>Our reel includes creatures from X-Men: First Class, Dark Shadows, The Wolfman and Prometheus.</p>
                            </div>
                        </article>
                        <!-- End News -->
                    </div>
				...
				<div class="row">
					<div class="col-sm-3 g-margin-b-30--xs g-margin-b-0--md">
                        <!-- News -->
                        <article>
                            <img class="img-responsive" src="img/970x970/environment.png" alt="Image" style="height:100%;width:100%;">
                            <div class="g-bg-color--white g-box-shadow__dark-lightest-v2 g-text-center--xs g-padding-x-40--xs g-padding-y-40--xs">
                                <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2">
									<a href="#environment" data-toggle="modal">ENVIRONMENT REEL</a>
								</p>
                                <p>Watch our Environment Reel featuring World War Z, Prometheus, Skyfall and Man of Steel.</p>
                            </div>
                        </article>
                        <!-- End News -->
                    </div>
